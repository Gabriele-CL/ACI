...
public class SUT_C01_06 {
    ...
    public void ACI_Sportello_UT() throws InterruptedException {
        ...
        for (WebElement riga : righe) {
            ...
            if (confermaElimi.contains("An error occurred, please contact your system administrator.")) {

                System.out.println("L'appuntamento non può essere eliminato, verifica corretta");
                Sportello.confEliminazione();
