...
public class SUT_C03_02 {
    ...
    public void beforetest() throws InterruptedException {
        ...
        try {
            ...
            // Il popup non è comparso, nessuna azione necessaria
        }
    ...
    public void ACI_Sportello_UT() throws InterruptedException {
        ...
        Thread.sleep(2000);
        Sportello.clickOnline();
        Thread.sleep(2000);
        Sportello.clickInfoGenerali();
        Thread.sleep(2000);
        Sportello.compilaRichiesta();
        Thread.sleep(4000);
