...
public class SUT_C01_02 {
    ...
    public void ACI_Sportello_UT() throws InterruptedException {
        ...
        while (true) {
            ...
            String slot = Sportello.selezionaOrarioSlot("11:00");

            if (slot == null) {
                System.out.println("Nessuno slot disponibile per quell'ora. Fine ciclo.");
                break;
            }

            System.out.println("Slot selezionato: " + slot);
