package com.aci.test.ACI_CalcoloBollo;

import com.aci.test.POM.CalcoloBolloPage;
import com.aci.test.POM.CalcoloTariffePage;
...
public class ACI_CalcoloBollo_perTarga_Test {
    ...
    public void Foglio1(String Cod_Test, String Cod_Classe, String Targa, String TipoVeicolo,
        ...
        // Imposta Data Calcolo
        objCalBollo.setDataCalcolo(DataCalcolo);

        // Imposta Pagamento Anticipato
        if (PagamentoAnticipato.contains("NO")) {
            System.out.println("Nessun pagamento anticipato");
        } else if (PagamentoAnticipato.contains("SI")) {
            objCalBollo.setPagAnticipato();
        }
        ...
        String conteggio = objCalBollo.setTotale();
        System.out.println(conteggio);
        String terminePagamento = objCalBollo.setTerminePagamento();
        String dataDecorrenza1 = objCalBollo.setDataDecorrenza();
        String dataScadenza1 = objCalBollo.setDataScadenza();
        String tassa = objCalBollo.setTassa();
        String sanzione = objCalBollo.setSanzione();
        String interessi = objCalBollo.setInteressi();
    ...
    public void printexcel () throws IOException {
        ...
        for (int r = 0; r < rows; r++) //0 row is created
        {
            ...
            String filePath = System.getProperty("user.dir") + "//src/test/java/com/aci/fileOutput/ACIResults_BolloPerTarga_" + formatedDateTime + ".xlsx";
            ...
            String koreultsPath = System.getProperty("user.dir") + "//src/test/java/FileOutput/KO_Test_BolloPerTarga_" + formatedDateTime + "." + "xlsx";
