...
public class Login_Sinta {
    ...
    @FindBy(xpath = "//input[@title=\"Pagina contenente l'elenco applicazioni\"]")
    WebElement elencoAppli;
    ...
    @FindBy(xpath = "//input[@name='action_goTo_76000']")
    WebElement archivioTribu;

    @FindBy(xpath = "//*[@id=\"proceed-button\"]")
    WebElement inviaComunq;
    ...
    public void enterCrendentials2() throws InterruptedException {
        this.username.sendKeys("g.marcantonit");
        this.password.sendKeys("iniziale");
        Thread.sleep(1000);
        this.loginButton.click();
        Thread.sleep(3000);
        this.elencoAppli.click();
        this.archivioTribu.click();

        String handlePrimaPagina = driver.getWindowHandle();

        for (String handle : driver.getWindowHandles()) {
            if (!handle.equals(handlePrimaPagina)) {
