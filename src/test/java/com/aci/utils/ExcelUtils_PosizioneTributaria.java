...
public class ExcelUtils_PosizioneTributaria {
...

        {
            ...
            File f = new File(System.getProperty("user.dir")+"//src/test/resources/PosizioneTributaria/Targhe_per_Posizione_Tributaria_Finale.xlsx");
