...
public class ExcelUtils_InstanzaRimborso {
...

    {
        ...
        File f = new File(System.getProperty("user.dir")+"//src/test/resources/Instanza/DataPool_Rimborsi.Lazio_08-05-2023.xlsx");
