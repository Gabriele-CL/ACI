...
public class ExcelUtils_InstanzaRimborsoPH {
    ...
    public static Object[][] getData(Method m) throws EncryptedDocumentException, IOException {
        ...
        File f = new File(System.getProperty("user.dir") + "//src/test/resources/Instanza/DataPool_Rimborsi.Regimi_Speciali_PH.xlsx");
